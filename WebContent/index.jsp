            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="img/soboro.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/pizza.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/croissant.jpg" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
